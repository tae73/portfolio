...
### 2. LLM-Factor RecSys (H&M) 🚧 In Progress
...
### 3. Multi-Task Debiasing for RTB Win/CTR Prediction — iPinYou

> Win Selection Bias Debiasing (ESMM-WC, ESCM²-WC with Doubly Robust estimation)
